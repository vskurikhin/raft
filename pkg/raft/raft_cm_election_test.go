...
// на распределении значений, возвращаемых electionTimeout() (ADR-015,
// INV-T11). На уровне кластера эффекта нет и быть не может: хук не
...
func TestElectionTimeout_ForcedReelectionHook(t *testing.T) {
	// t.Setenv несовместим с t.Parallel — тест остаётся serial (ADR-010, §15).
