...
// Текущее значение 165 мс = 330/2. Вынесено в независимую константу, чтобы
// настройка таймеров для тестового ускорения не влияла на production-развёртывание.
// Единый источник значения: корневой пакет и пакеты реализаций переэкспортируют
// её через алиасы.
const TCPRPCTimeout = 165 * time.Millisecond
