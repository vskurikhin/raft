...
// может переизбрать лидера во время коммита (таймеры выборов в
...
// TestSnapshot_ClusterFullRestart — регрессионный тест FINDING-013:
// после снапшотов и компактирования логов полный рестарт ВСЕХ узлов
...
func TestSnapshot_ClusterFullRestart(t *testing.T) {
	...
	// Ждём снапшот и компактирование на КАЖДОМ узле.
	for _, n := range nodes {
	...
	// Каждый узел восстановил состояние до линии компактирования (k0),
