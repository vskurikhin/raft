...
// Connect сохраняет адрес для указанного peer'а. Если адрес изменился —
...
// удаляет все peers, закрывает все соединения в пуле и активные входящие
...
// Используется при реконфигурации кластера, когда адреса peer'ов
// могли измениться.
...
// lookupPeer возвращает адрес peer'а по его ID.
