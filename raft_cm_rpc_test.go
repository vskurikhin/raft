...
// ConflictIndex по границе снимка в ветке PrevLogIndex > lastLogIndex
// (raft_cm_rpc.go, ветка :177-179): follower с пустым журналом и снимком
// на индексе N возвращает ConflictIndex = N+1, а не 0 — follower никогда
// не запрашивает записи, покрытые его собственным снимком.
//
// Согласованное состояние (после): lastLogIndex == N.
