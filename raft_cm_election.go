...
func (cm *ConsensusModule) becomeFollower(term int) {
	...
	// Сбросить inflightAE для всех соседей при потере лидерства.
	...
	if wasLeader {
		// Уничтожение состояния задержки повторов вместе с выходом из роли
		// жизненный цикл полей строго следует роли
...
// голосующим (Suffrage == Nonvoter), таймер немедленно завершается — неголосующий
...
//   - истечении таймаута выборов без кворума → becomeFollower()
//   - обнаружении более высокого терма от другого узла → becomeFollower()
//
