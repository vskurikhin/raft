...
//
// Предусловие: transport не должен быть nil. При нарушении функция аварийно
// завершается (fail-fast) — это единственная проверка до старта горутин.
// Она корректно обрабатывает как чистый nil-интерфейс, так и типизированный
// nil-указатель (например, (*InmemTransport)(nil)) через isNilInterface.
