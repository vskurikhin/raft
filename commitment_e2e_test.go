...
// у future нет собственного таймаута (future.go), поэтому голый
...
func TestCommitmentE2E_FourNodes_TwoDownNoCommit(t *testing.T) {
	...
	// зафиксироваться при 2/4 (старый код фиксировал бы на первом ack).
	select {
...
// при одном отключённом follower (живы 3/4 = кворум) фиксация проходит —
...
// при отключённом follower (жив 1/2) команда НЕ фиксируется.
// После восстановления — 2/2.
