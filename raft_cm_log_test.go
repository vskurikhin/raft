...
// записей): срез после вставки гарантированно непуст, ветка недостижима,
// результат — последняя вставленная запись (анализ побочных эффектов п.1).
