...
//
// Значения alive снимаются под h.mu; создание CM, подключение
...
// вне блокировки (инвариант границ). При исчерпании бюджета —
...
// ровно один лидер, и возвращает его ID и term. Задержка повторов репликации
// задерживает step-down прежнего лидера (его первые AE
